...
public class WechatService {
    ...
    public void pushArticle(String openId) {
        ...
        // 情话
        templateMessage.addData(new WxMpTemplateData("lovePhrase", PhraseUtils.getRainbowFrats(key), "#FF69B4"));
        // 日期
        ...
        // 纪念日
        templateMessage.addData(new WxMpTemplateData("loveDay", AnniversaryUtils.getRelationship(relDate) + "", "#FF1493"));
        //节假日
        ...
        // 生日
        templateMessage.addData(new WxMpTemplateData("fBirthday", AnniversaryUtils.getBirthday(fBirth) + "", "#FFA500"));
        templateMessage.addData(new WxMpTemplateData("mBirthday", AnniversaryUtils.getBirthday(mBirth) + "", "#FFA500"));
